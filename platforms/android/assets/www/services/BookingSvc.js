    ...
    function BookingSvc() {
        ...
        function disselected(){
            ...
            if (vm.pickedDates[2]) {
                ...
                while (diff != 0) {
                    vm.reservationData[d1.month() + 1][d1.format('YYYY-M-D')]['class'] =
                        vm.reservationData[d1.month() + 1][d1.format('YYYY-M-D')]['class'].replace('picked', '');
                    d1.add(1, 'days');
        ...
        function setRangepick(date1, date2) {
            ...
            while (diff != 0) {
                ...
                if (!vm.reservationData[date1.month() + 1][date1.format('YYYY-M-D')]) {
                    vm.reservationData[date1.month() + 1][date1.format('YYYY-M-D')] = {};
                    vm.reservationData[date1.month() + 1][date1.format('YYYY-M-D')]['class'] = 'picked';
                } else {
                    vm.reservationData[date1.month() + 1][date1.format('YYYY-M-D')]['class'] += ' picked';
                    if (vm.reservationData[date1.month() + 1][date1.format('YYYY-M-D')]['booking-id']) {
                        is_reserved = true;
                    }
                }
